...
<body>
 <form action="goodsctrl/add.do" method="post" enctype="multipart/form-data" name="myform">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="d5d4d4" >
  <tr>
    <td height="22" colspan="4" background="images/bg.gif" bgcolor="#FFFFFF" class="STYLE3"><div align="center">商品新增</div></td>
  </tr>
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="STYLE1"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="352" height="35" class="STYLE1"><div align="left">
          <input type="text" name="itemName"   style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; "   />
        </div></td>
        <td width="173" height="35" class="STYLE1"nowrap="nowrap"><div align="left">商品价格</div></td>
        <td width="188" height="35" class="STYLE1"><div align="left">
          <input type="text" name="cid"   style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; "  />
        </div></td>
      </tr>
      <tr>
        ...
        <td height="35" colspan="3" class="STYLE1"><div align="left">
          <input type="text" name="itemProductor"   style="width:300px; height:17px; font-size:12px; border:solid 1px #ccc; "  />
        </div></td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="35" class="STYLE1"><div align="left">
          <input type="text" name="priceVip"   style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " />
        </div></td>
        <td height="35" class="STYLE1"><div align="center" nowrap="nowrap">
          <div align="left">普通价格</div>
        </div></td>
        <td height="35" class="STYLE1"><div align="left">
          <input type="text" name="priceNormal"   style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; "/>
        </div></td>
      </tr>
      <tr>
        <td width="142" height="35" class="STYLE1"><div align="center" nowrap="nowrap">
        ...
        <td height="35" class="STYLE1"><div align="left">
          <input type="text" name="itemNum"   style="width:200px; height:17px; font-size:12px; border:solid 1px #ccc; " />
        </div></td>
        <td height="35" class="STYLE1"><div align="center" nowrap="nowrap">
      ...
      <tr>
        ...
        <td height="35" colspan="3" class="STYLE1"><div align="left">
          <textarea name="itemIntro"  style=" width:600px; height:100px;"></textarea>
        </div></td>
        </tr>
      <tr>
      <!-- 其他数据就使用隐藏域 -->
            <input type="hidden" name="itemTotNum" value="1">
